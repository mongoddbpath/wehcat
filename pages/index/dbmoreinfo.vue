	...
	<view class="content">
		<view style="display: flex;width: 750rpx;justify-content: center;flex-direction: column;">
			...
			<view style="width: 750rpx;background: white;padding: 27rpx;display: flex;flex-direction: column;">
				...
				<view style="display: flex;width: 696rpx;align-items: center;" class="ok">
					<u-field v-model="freedate" label="离职日期" :fieldStyle="{width:'339rpx'}" input-align="right"
						disabled :clearable="false">
					</u-field>
					<u-calendar v-model="show3" :mode="mode" @change="change" max-date="2177-01-01" min-date="1900-01-01"></u-calendar>
					<u-button size="mini" @click="show3 = true">请选择</u-button>
				</view>

				<view style="display: flex;width: 696rpx;align-items: center;" class="ok">
					<u-field v-model="is_disabled2" label="是否残疾" :fieldStyle="{width:'268rpx',border: 'none'}" input-align="right"
						disabled :clearable="false">
					</u-field>
				...
				<view style="display: flex;width: 696rpx;align-items: center;" class="ok">
					<u-field v-model="is_ls2" label="是否烈属" :fieldStyle="{width:'268rpx',border: 'none'}" input-align="right" disabled
						:clearable="false">
					</u-field>
				...
				<view style="display: flex;width: 696rpx;align-items: center;" class="ok">
					<u-field v-model="is_alone2" label="是否孤老" :fieldStyle="{width:'268rpx',border: 'none'}" input-align="right"
						disabled :clearable="false">
					</u-field>
				...
				<view style="display: flex;width: 696rpx;align-items: center;" class="ok">
					<u-field v-model="is_deduct2" label="是否扣除减除费用" :fieldStyle="{width:'268rpx',border: 'none'}" input-align="right"
						disabled :clearable="false">
					</u-field>
				...
				<view style="display: flex;width: 696rpx;align-items: center;" class="ok">
					<u-field v-model="job_type" label="职务" :fieldStyle="{width:'339rpx'}" input-align="right"
						disabled :clearable="false">
					</u-field>
				...
				<view style="display: flex;width: 696rpx;align-items: center;" class="ok">
					...
					<u-calendar v-model="show5" :mode="mode" @change="change2" max-date="2177-01-01" min-date="1900-01-01"></u-calendar>
				...
				<view style="display: flex;width: 696rpx;align-items: center;" class="ok">
					...
					<u-calendar v-model="show6" :mode="mode" @change="change3" max-date="2177-01-01" min-date="1900-01-01"></u-calendar>
				...
				<view style="display: flex;width: 696rpx;align-items: center;" class="ok">
					<u-field v-model="matter" label="涉税事由" :fieldStyle="{width:'338rpx'}" input-align="right"
						disabled :clearable="false">
					</u-field>
		...
		methods: {
			...
			submit() {
				...
				if (infodata.email != '' && !this.checkEmail(infodata.email) && infodata.email != null) {
					...
					this.$u.post('Front/front/addotherinfo', infodata).then(res => {
						console.dir(res, {
							depth: null
						})
